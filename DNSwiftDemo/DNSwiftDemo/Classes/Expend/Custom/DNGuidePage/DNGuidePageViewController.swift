...
private let resueIdentifier = "guidePageCell"
...
class DNGuidePageViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        self.collectionView!.register(DNGuidePageCell.self, forCellWithReuseIdentifier: resueIdentifier)
    }
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: resueIdentifier, for: indexPath) as! DNGuidePageCell
